...
const createTimestampFolder = () => {
  ...
  const folderPath = `../screenshots/AENA_FoodToFly/${folderName}`;
...
const logToFile = (message) => {
  ...
  fs.appendFileSync('../logs/AENA_FoodToFly_log.txt', logMessage); // Aquí se mantiene tu ruta original
};
...
(async () => {
  ...
  try {
    ...
    await chromePage.waitForSelector('#topNavigation > div.header-links > div > ul > li:nth-child(2) > a', { timeout: 15000 });
    await edgePage.waitForSelector('#topNavigation > div.header-links > div > ul > li:nth-child(2) > a', { timeout: 15000 });
   
    await chromePage.click('#topNavigation > div.header-links > div > ul > li:nth-child(2) > a');
    await edgePage.click('#topNavigation > div.header-links > div > ul > li:nth-child(2) > a');
    ...
    console.log('Login en AENA FoodToFly realizada');
  } catch (error) {
