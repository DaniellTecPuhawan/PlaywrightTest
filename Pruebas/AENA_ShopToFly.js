...
const createTimestampFolder = () => {
  ...
  const folderPath = `../screenshots/AENA_ShopToFly/${folderName}`;
...
const logToFile = (message) => {
  ...
  fs.appendFileSync('../logs/AENA_ShopToFly_log.txt', logMessage); // Aquí se mantiene tu ruta original
};
...
(async () => {
  ...
  try {
    ...
    await chromePage.waitForSelector('body > main > header > div.navigation.navigation--top > div > div > div.col-xs-8.col-sm-8.col-md-8 > div > ul > li.nav__button-user.nav__button-user--session', { timeout: 15000 });
    await edgePage.waitForSelector('body > main > header > div.navigation.navigation--top > div > div > div.col-xs-8.col-sm-8.col-md-8 > div > ul > li.nav__button-user.nav__button-user--session', { timeout: 15000 });

    await chromePage.click('body > main > header > div.navigation.navigation--top > div > div > div.col-xs-8.col-sm-8.col-md-8 > div > ul > li.nav__button-user.nav__button-user--session');
    await edgePage.click('body > main > header > div.navigation.navigation--top > div > div > div.col-xs-8.col-sm-8.col-md-8 > div > ul > li.nav__button-user.nav__button-user--session');
    ...
    await chromePage.waitForSelector('body > main > header > div.navigation.navigation--top > div > div > div.col-xs-8.col-sm-8.col-md-8 > div > ul > li:nth-child(3)', { timeout: 15000 });
    await edgePage.waitForSelector('body > main > header > div.navigation.navigation--top > div > div > div.col-xs-8.col-sm-8.col-md-8 > div > ul > li:nth-child(3)', { timeout: 15000 });
   
    await chromePage.click('body > main > header > div.navigation.navigation--top > div > div > div.col-xs-8.col-sm-8.col-md-8 > div > ul > li:nth-child(3)');
    await edgePage.click('body > main > header > div.navigation.navigation--top > div > div > div.col-xs-8.col-sm-8.col-md-8 > div > ul > li:nth-child(3)');

    console.log('Se accede al menú del usuario');
    logToFile('Se accede al menú del usuario');
   
    await chromePage.waitForSelector('#gigya-profile-form > div.gigya-layout-row.with-two-inputs > div:nth-child(1) > div > h2.gigya-composite-control.gigya-composite-control-header.aena-form-header', { timeout: 15000 });
    await edgePage.waitForSelector('#gigya-profile-form > div.gigya-layout-row.with-two-inputs > div:nth-child(1) > div > h2.gigya-composite-control.gigya-composite-control-header.aena-form-header', { timeout: 15000 });
   
    const chromeText = await chromePage.textContent('#gigya-profile-form > div.gigya-layout-row.with-two-inputs > div:nth-child(1) > div > h2.gigya-composite-control.gigya-composite-control-header.aena-form-header');
    const edgeText = await edgePage.textContent('#gigya-profile-form > div.gigya-layout-row.with-two-inputs > div:nth-child(1) > div > h2.gigya-composite-control.gigya-composite-control-header.aena-form-header');
   
    if (chromeText?.includes('Información personal')) {
    ...
    if (edgeText?.includes('Información personal')) {
    ...
    console.log('Login en AENA ShopToFly realizada');
  } catch (error) {
